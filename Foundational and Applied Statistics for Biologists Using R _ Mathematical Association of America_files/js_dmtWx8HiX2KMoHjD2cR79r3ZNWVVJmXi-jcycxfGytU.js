...
* Provide the HTML to create the modal dialog.
*/
Drupal.theme.prototype.NvlModalsCToolsModal = function () {
  var html = ''
  ...
  html += '            <div class="modal-header popups-title"><img src="/sites/all/themes/maa/logo-small-white.png" />';
  //html += '              <span id="modal-title" class="modal-title"></span>';
  html += '              <span class="popups-close"><a class="close" href="#">' + Drupal.CTools.Modal.currentSettings.closeText + '</a></span>';
  html += '              <div class="clear-block"></div>';
  html += '            </div>';
  html += '            <div class="modal-scroll"><div id="modal-content" class="modal-content popups-body" style="height:auto!important;"></div></div>';
